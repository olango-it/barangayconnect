  ...
  return (
    <div>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4">
        <h2 className="font-heading text-2xl font-bold mb-8">Our History</h2>
        <div className="space-y-8">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <img
              src="https://media.base44.com/images/public/6a1d00c12929ea8d18f9682c/37349c04f_471186640_992683042889635_8419259815476639420_n.jpg"
              alt="Coastal fishing boats and docks showcasing maritime livelihood"
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <img
              src="https://media.base44.com/images/public/6a1d00c12929ea8d18f9682c/ad142ccc8_baliw-02-1.jpg"
              alt="Baliw-Baliw Festival celebration with community members in the water"
              className="rounded-2xl shadow-lg w-full h-80 object-cover"
            />
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
            <img
              src="https://media.base44.com/images/public/6a1d00c12929ea8d18f9682c/997012a0d_oiws.jpg"
              alt="Olango Island aerial view showing mangrove areas and wildlife sanctuary"
              className="rounded-2xl shadow-lg w-full h-80 object-cover"
            />
          </motion.div>
